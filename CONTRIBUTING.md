# Contributing to rc-worm

Thank you for your interest in contributing to rc-worm! This document provides guidelines and information for contributors.
...
1. Check the [existing issues](https://github.com/ai-quokka-wannabe/rc-worm/issues) to avoid duplicates
2. Ensure you're using the latest version
3. Collect relevant information:
    - Operating system and version
    - Qt version and kit (MinGW or MSVC)
    - The TronGrid Lite and Master Control builds the worm was plugged into
...
- Include the Grid's log lines around the Program load if relevant
...
- [ ] The Program loads in the Grid (`TronGridLite --list-programs` says USABLE)
...
**Note:** Code identifiers may use American spelling where it matches library/API conventions (e.g., Qt API names).
...
```text
feat(body): add the glass-neon segment
...
- Open a [Discussion](https://github.com/ai-quokka-wannabe/rc-worm/discussions) for questions
